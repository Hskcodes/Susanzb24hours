...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002340754796"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002010997108"))
...
OWNER_ID = int(os.environ.get("OWNER_ID", "6487850142"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6763725032 6703858774").split()):
        ADMINS.append(int(x))
except ValueError:
